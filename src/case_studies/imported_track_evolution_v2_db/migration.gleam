...
5	added_to_library_at	INTEGER	0	NULL	0
6	external_source_url	TEXT	0	NULL	0
7	created_at	INTEGER	1	NULL	0
8	updated_at	INTEGER	1	NULL	0
9	deleted_at	INTEGER	0	NULL	0"
      ...
      case first_mismatched_column_name(rows, importedtrack_columns_wanted) {
        ...
        None ->
          case first_missing_column(rows, importedtrack_columns_wanted) {
            ...
            None ->
              panic as "case_studies/imported_track_evolution_v2_db/migration: no column fix applies"
          }
      }
  }
}
...
fn reconcile_importedtrack_columns_loop(
  ...
  case iter > 64 {
    True ->
      panic as "case_studies/imported_track_evolution_v2_db/migration: column reconcile did not converge"
    False -> {
