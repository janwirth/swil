...
const soft_delete_item_by_name_sql = "update \"item\" set \"deleted_at\" = ?, \"updated_at\" = ? where \"name\" = ? and \"deleted_at\" is null returning \"name\";"
...
pub fn delete_item_by_name(
  ...
  case rows {
    [Nil, ..] -> Ok(Nil)
    [] -> Error(not_found_item_name_error("delete_item_by_name"))
  }
}
