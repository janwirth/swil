...
pub fn generate_full_from_path(path: String) -> GeneratedStructure {
  ...
  let schema_module = schema_context.schema_module_from_src_path(path)
  generate_full(module, schema_module)
}
...
pub fn generate_full(
  ...
  let assert Ok(ctx) = schema_context.parse(module, schema_module)
  GeneratedStructure(
