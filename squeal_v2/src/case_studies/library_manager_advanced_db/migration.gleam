        ...
        )
      {
        ...
        None ->
            ...
            )
          {
            ...
            None ->
              panic as "case_studies/library_manager_advanced_db/migration: no column fix applies"
          }
      }
  }
}
...
fn reconcile_importedtrack_columns_loop(
  ...
  case iter > 64 {
    True ->
      panic as "case_studies/library_manager_advanced_db/migration: column reconcile did not converge"
    False -> {
