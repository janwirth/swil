...
const importedtrack_upsert_by_service_and_source_id_sql = "insert into \"importedtrack\" (\"from_source_root\", \"title\", \"artist\", \"file_path\", \"service\", \"source_id\", \"added_to_library_at\", \"external_source_url\", \"created_at\", \"updated_at\", \"deleted_at\")
values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, null)
...
const importedtrack_update_by_service_and_source_id_sql = "update \"importedtrack\" set \"title\" = ?, \"artist\" = ?, \"file_path\" = ?, \"added_to_library_at\" = ?, \"external_source_url\" = ?, \"updated_at\" = ? where \"from_source_root\" = ? and \"service\" = ? and \"source_id\" = ? and \"deleted_at\" is null;"
...
const importedtrack_update_by_id_sql = "update \"importedtrack\" set \"from_source_root\" = ?, \"title\" = ?, \"artist\" = ?, \"file_path\" = ?, \"service\" = ?, \"source_id\" = ?, \"added_to_library_at\" = ?, \"external_source_url\" = ?, \"updated_at\" = ? where \"id\" = ? and \"deleted_at\" is null;"
