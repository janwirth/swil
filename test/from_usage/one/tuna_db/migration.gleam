...
4	file_path	TEXT	0	NULL	0
5	service	TEXT	0	NULL	0
6	source_id	TEXT	0	NULL	0
7	added_to_library_at	INTEGER	0	NULL	0
8	external_source_url	TEXT	0	NULL	0
9	created_at	INTEGER	1	NULL	0
10	updated_at	INTEGER	1	NULL	0
11	track_bucket_trackbucket_id	INTEGER	0	NULL	0
        ...
        )
      {
        ...
        None ->
            ...
            )
          {
            ...
            None ->
              panic as "from_usage/one/tuna_db/migration: no column fix applies"
          }
      }
  }
}
...
fn reconcile_importedtrack_columns_loop(
  ...
  case iter > 64 {
    True ->
      panic as "from_usage/one/tuna_db/migration: column reconcile did not converge"
    False -> {
