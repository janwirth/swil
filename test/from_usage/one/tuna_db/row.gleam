...
pub fn importedtrack_with_magic_row_decoder() -> decode.Decoder(
  ...
  use file_path_raw <- decode.field(3, decode.string)
  use service_raw <- decode.field(4, decode.string)
  use source_id_raw <- decode.field(5, decode.string)
  use added_to_library_at_raw <- decode.field(6, decode.int)
  use external_source_url_raw <- decode.field(7, decode.string)
  ...
  let file_path = api_help.opt_string_from_db(file_path_raw)
