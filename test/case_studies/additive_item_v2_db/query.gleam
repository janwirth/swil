...
const page_edited_item_sql = "select \"name\", \"age\", \"height\", \"id\", \"created_at\", \"updated_at\", \"deleted_at\" from \"item\" where \"deleted_at\" is null order by \"updated_at\" desc limit ? offset ?;"

const last_100_item_sql = "select \"name\", \"age\", \"height\", \"id\", \"created_at\", \"updated_at\", \"deleted_at\" from \"item\" where \"deleted_at\" is null order by \"updated_at\" desc limit 100;"
