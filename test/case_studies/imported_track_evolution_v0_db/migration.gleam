      ...
      case first_mismatched_column_name(rows, importedtrack_columns_wanted) {
        ...
        None ->
          case first_missing_column(rows, importedtrack_columns_wanted) {
            ...
            None ->
              panic as "case_studies/imported_track_evolution_v0_db/migration: no column fix applies"
          }
      }
  }
}
...
fn reconcile_importedtrack_columns_loop(
  ...
  case iter > 64 {
    True ->
      panic as "case_studies/imported_track_evolution_v0_db/migration: column reconcile did not converge"
    False -> {
